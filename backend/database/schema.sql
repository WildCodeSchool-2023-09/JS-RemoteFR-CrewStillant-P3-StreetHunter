...
INSERT INTO
    user (
        username, lastname, firstname, email, password, score, city, postal_code, is_admin
    )
VALUES (
...
INSERT INTO
    messaging (
        title, body, created_at, is_read, user_id
    )
VALUES (
        'ca va pas', 'Bonjour, ca va pas jai pas mes points', '2024-01-25 09:29:15', 1, 1
    ),
    (
        'ca va pas', 'Bonjour, ca va pas jai pas mes points', '2024-01-25 09:29:15', 0, 1
    );

INSERT INTO
    artwork (
        path_pic, title, longitude, latitude, validated, category_id, artist_id, user_id
    )
VALUES (
