export default function InstructionsPage() {
  return (
    <article>
      ...
      <h2>Types de Contenu à Signaler</h2>
      <p>
        ...
        pornographique ou sexuellement explicite. Contenu frauduleux, trompeur
        ou nuisible.
      </p>
      <h2>Comment Signaler un Contenu</h2>
      <p>
        ...
        des détails spécifiques. Si le système de signalement n'est pas
        disponible ou pour des cas urgents, contactez notre équipe de modération
        à administrator@mappingart.com.
      </p>
      <h2>Conséquences du contenu inapproprié</h2>
      <p>
      ...
      <p>
        ...
        une communauté en ligne sûre. Les utilisateurs qui signalent de manière
        intentionnellement fausse ou abusive peuvent également faire l'objet de
        sanctions. Merci de contribuer à rendre MAPPING ART un espace
