    ...
    <div className=" ">
      ...
      <div className="flex flex-col align-bottom">
        {auth ? (
          <Link
            type="button"
            className="flex flex-row justify-center items-center mx-20 lg:mx-[40rem] focus:bg-[#90b48c] hover:bg-[#a2cb9e]  rounded-md outline outline-[#957C58] outline-offset-2 text-primary text-2xl font-secondary font-light  bg-backgroundThree my-5 lg:mb-2"
