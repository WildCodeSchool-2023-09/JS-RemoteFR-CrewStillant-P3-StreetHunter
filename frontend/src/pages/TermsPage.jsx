export default function TermsPage() {
  return (
    <article>
      ...
      <ul>
        <li>Nom de l'entreprise : Street Art Hunter</li>
        <li>Adresse : 1 rue du code, 75000 Paris</li>
        <li>Téléphone : 01 02 03 04 05 06</li>
        <li>Adresse e-mail : strart@wsc.com</li>
      </ul>
      ...
      <h2>3. Proriété Intellectuelle</h2>
